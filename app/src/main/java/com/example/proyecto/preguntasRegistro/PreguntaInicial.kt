...
import com.example.proyecto.registro.registro_inicial  // Asegúrate de importar la clase de RegistroInicial si está en otro paquete
...
class PreguntaInicial : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TextView para ir a RegistroInicial
        val textView = findViewById<TextView>(R.id.textView14)
        textView.setOnClickListener {
            val intent = Intent(this, registro_inicial::class.java)  // Cambia RegistroInicial a tu clase de registro
            startActivity(intent)
        }
    }
}
